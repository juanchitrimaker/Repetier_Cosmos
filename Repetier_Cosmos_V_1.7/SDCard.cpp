...
#else
        //Printer::moveToReal(Printer::xMin, Printer::yMin + Printer::yLength, IGNORE_COORDINATE, IGNORE_COORDINATE, Printer::maxFeedrate[X_AXIS]); // VER MAXI SD_PAUSA: PAUSE - Cambiado por la linea de abajo
        Printer::moveToReal(PAUSE_POSITION_X, PAUSE_POSITION_Y, IGNORE_COORDINATE, IGNORE_COORDINATE, Printer::maxFeedrate[X_AXIS]);
#endif
