...
*/
#define UI_DISPLAY_CHARSET 1 // VER MAXI - Decía: 2
...
*/
#ifndef BEEPER_TYPE
  #define BEEPER_TYPE 0                         // VER MAXI - Decia: 1 - Lo desactivo y pongo 0
...
#define UI_MATRIX_ACTIONS {UI_ACTION_HOME_ALL,                      UI_ACTION_TOP_MENU,                       UI_ACTION_SET_ORIGIN,           UI_ACTION_BED_CALIBRATION,\
                           UI_ACTION_BED_CALIBRATION_P1,            UI_ACTION_BED_CALIBRATION_P2,             UI_ACTION_BED_CALIBRATION_P3,\
